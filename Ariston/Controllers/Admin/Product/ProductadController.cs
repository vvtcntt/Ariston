...
namespace Ariston.Controllers.Admin.Product
{
    public class ProductadController : Controller
    {
        ...
        public ActionResult Create(tblProduct tblproduct, FormCollection Collection, string id, List<HttpPostedFileBase> uploadFile)
        {
            ...
            if (nidCate != "")
            {
                ...
                clsSitemap.CreateSitemap("Product/" + tblproduct.Tag+"-"+tblproduct.idCate+"-"+tblproduct.id+".aspx", listprro[0].id.ToString(), "Product");
        ...
        public ActionResult Edit(int? id)
        {
            ...
            if (ClsCheckRole.CheckQuyen(4, 2, int.Parse(Request.Cookies["Username"].Values["UserID"])) == true)
            {
                ...
                string chuoicap = "";
                int capacity=0;
                string ncap = tblproduct.Capacity.ToString();
                if(ncap!=null && ncap!="")
                 capacity= int.Parse(tblproduct.Capacity.ToString());
                foreach (var item in listCapacity)
                {
            ...
            if (ModelState.IsValid)
            {
                if (collection["drMenu"] != "" || collection["drMenu"] != null)
                {
                    ...
                    if (collection["Price"] != null)
                    {
                        ...
                        tblproduct.PriceString = StringClass.UpdatePrice(Price.ToString());
                    ...
                    if (collection["PriceSale"] != null)
                    {
                        ...
                        tblproduct.PriceSaleString = StringClass.UpdatePriceSale(PriceSale.ToString());
                    ...
                    if (URL == true)
                    {
                        ...
                        clsSitemap.UpdateSitemap("Product/" + tblproduct.Tag + "-" + tblproduct.idCate + "-" + tblproduct.id + ".aspx", id.ToString(), "Product");
