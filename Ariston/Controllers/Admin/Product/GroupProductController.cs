...
namespace Ariston.Controllers.Admin.Product
{
    public class GroupProductController : Controller
    {
        ...
        public ActionResult Create(tblGroupProduct tblgroupproduct, FormCollection collection)
        {
                ...
                clsSitemap.CreateSitemap("ListProduct/"+StringClass.NameToTag(tblgroupproduct.Name) + "-"+tblgroupproduct.id+".aspx", id, "GroupProduct"); 
        ...
        public ActionResult Edit(tblGroupProduct tblgroupproduct, FormCollection collection, int id )
        {
            if (ModelState.IsValid)
            {
                ...
                clsSitemap.CreateSitemap("ListProduct/" + StringClass.NameToTag(tblgroupproduct.Name) + "-" + tblgroupproduct.id + ".aspx", id.ToString(), "GroupProduct");
