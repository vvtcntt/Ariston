...
namespace Ariston.Controllers.Display.Product
{
        ...
        public ActionResult OrderIndex()
        {
            ...
            { 
                for (int i = 0; i < giohang.CartItem.Count; i++)
                {
                    ...
                    chuoi += "<td class=\"Name\" >";
                    chuoi += "<a href=\"/Product/" + giohang.CartItem[i].Tag + "-" + giohang.CartItem[i].id+ ".aspx\" title=\"" + giohang.CartItem[i].Name + "\" id=\"UpdateOrd" + giohang.CartItem[i].id + "\"><img src=\"" + giohang.CartItem[i].Images + "\" alt=\"" + giohang.CartItem[i].Name + "\" title=\"" + giohang.CartItem[i].Name + "\" /></a>";
                    chuoi += "<a href=\"/Product/" + giohang.CartItem[i].Tag + "-" + giohang.CartItem[i].id + ".aspx\" title=\"" + giohang.CartItem[i].Name + "\" class=\"Namepd\">" + giohang.CartItem[i].Name + "</a>";
