...
using Ariston.Models.Mapping;

namespace Ariston.Models
{
    public partial class AristonContext : DbContext
    {
        static AristonContext()
        {
            Database.SetInitializer<AristonContext>(null);
        }

        public AristonContext()
            : base("Name=AristonContext")
        {
        }
